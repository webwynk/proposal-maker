        ...
        <div class="project-card-saas" data-type="${p.project_type || 'Other'}">
          <div class="project-header">
            <div style="flex:1;">
              <div class="project-name">
                ...
                ${p.client_name ? `<small style="font-weight:500; color:var(--body); opacity:0.6; display:block; margin-top:6px; font-size:0.85rem;">Client: ${p.client_name}</small>` : ''}
              </div>
          ...
          <div class="milestone-section">
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:24px; padding-bottom:12px; border-bottom: 2px solid var(--bg);">
                <h4 style="font-size:0.8rem; font-weight:900; color:var(--title); text-transform:uppercase; letter-spacing:1.5px; margin:0;">Project Roadmap</h4>
            </div>
            <div class="milestone-grid">
                ...
                <div class="milestone-card add-milestone-card" onclick="openMilestoneModal(${p.id})">
                    ...
                    <div class="add-milestone-text" style="font-weight:700; font-size:0.85rem; text-transform:uppercase; letter-spacing:0.5px; margin-top:8px;">Add Phase</div>
                </div>
            </div>
          </div>
          ...
          <div style="display:flex; justify-content:space-between; align-items:center; margin-top:48px; padding-top:32px; border-top:1px solid var(--border);">
            ...
            <div style="display:flex; gap:16px;">
              <button class="btn btn-outline" onclick="editProject(${p.id})" style="padding: 12px 20px; font-weight:700;">Project Settings</button>
              <button class="btn btn-outline" style="color:var(--danger); border-color:rgba(239, 68, 68, 0.2); background:rgba(239, 68, 68, 0.02); padding: 12px 20px; font-weight:700;" onclick="deleteProject(${p.id})">Remove Project</button>
            </div>
          </div>
        </div>
      `;
